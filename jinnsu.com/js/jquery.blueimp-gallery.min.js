    ...
    t(document).on("click", "[data-gallery]", function(i) {
        var s = t(this).data("gallery"),
            ...
            a = {
                ...
                onopened: function() {
					//alert(document.getElementsByClassName("modal fade")[0].innerHTML);
                    n.trigger("opened")
                },
                onslide: function() {
					sasa=document.getElementsByClassName("active")[0].title;
					
					//alert(sasa);
					var opop=document.getElementsByTagName("h4");
					
					for(var i=0; i<opop.length-1; i++)
						{
							if(opop[i].innerHTML==sasa)
								{//alert(opop[i].innerHTML);
									opop=opop[i].previousSibling.previousSibling;
									opop.addEventListener("click", function(){
										alert("mamama");
										for(var i=0; i<document.getElementById("links").childNodes.length; i++)
											{
												if(document.getElementById("links").childNodes[i].title==sasa)
												{
													//alert(document.getElementById("links").childNodes[i].title);
													document.getElementById("links").removeChild(document.getElementById("links").childNodes[i]);
												}
											}
									});
									break;
                ...
                onclose: function() {
                    //alert(document.getElementsByClassName("modal fade")[0].innerHTML);
					//sasa=document.getElementsByClassName("modal-body next")[0].innerHTML;
					/*for(var i=0; i<document.getElementById("links").childNodes.length; i++)
					{
						if(document.getElementById("links").childNodes[i].title==sasa)
							document.getElementById("links").removeChild(document.getElementById("links").childNodes[i]);
                ...
                onclosed: function() {
                    //alert(sasa);
					//document.getElementById("links").removeChild(document.getElementById("links").childNodes[0]);
					//sasa=document.getElementsByClassName("modal-body next")[0].innerHTML;
					//alert(sasa+"999999999999"+document.getElementById("links").childNodes[0].title);
